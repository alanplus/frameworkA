...
public class HomeBottom extends LinearLayout {
    ...
    private XmViewPager yxViewPager;
    ...
    private void initView() {
        ...
        addView(line, new LayoutParams(-1, 1));
    ...
    public void setHomeBottomConfig(IHomeBottomConfig iHomeBottomConfig, final XmViewPager yxViewPager) {
