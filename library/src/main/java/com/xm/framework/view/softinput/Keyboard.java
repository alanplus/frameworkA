package com.xm.framework.view.softinput;
...
import com.xm.framework.media.download.TipMediaManager;
import com.xm.framework.view.softinput.listener.OnKeyBoradListener;
import com.xm.framework.view.softinput.listener.OnKeyClickListener;
import com.xm.framework.view.softinput.style.KeyBoardStyle;
...
public class Keyboard extends FrameLayout implements OnKeyBoradListener {
    ...
    public void onInputKeyClickListener(BaseKeyBoardCard baseKeyBoardCard, int keyCode, String text) {
        TipMediaManager.getInstance(getContext()).play("audio_key_m.mp3");
