...
import com.xm.framework.net.OkHttpUtil;
...
public class XmMediaplayer
    ...
    public void play(final String name, final IDownloadConfig iDownloadConfig, IMediaStateChangeListener iMediaStateChangeListener) {
        ...
        Observable.create(new ObservableOnSubscribe<String>() {
            ...
            public String apply(Throwable throwable) {
                setState(IMediaStateChangeListener.STATE_ERROR, IMediaStateChangeListener.ERROR_DOWNLOAD);
                return "error";
            }
        }).subscribe();
    }
